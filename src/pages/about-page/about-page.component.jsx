    ...
    return (
        <div className='about-page'>
            <p>
                ...
                who are disenfranchised to have access to afforable and easy-to-understand information about local resources.
                I want this to be a platform for case managers to communicate effectively
                about non-confidential information (bed availability, special events, open
                housing applications, etc) so the community can easily coordinate and collaborate to support
